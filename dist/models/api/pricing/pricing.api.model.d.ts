import { FeeComponentType, FeeUnit, ConnectorOutputType, RateDurationUnit, TariffRuleType } from '../../../enum/pricing';
...
export interface FeeCatalogDetailApiModel extends FeeCatalogListItemApiModel, AuditTimestampsApiModel {
    isDeleted: boolean;
...
export interface TariffRuleDetailApiModel extends TariffRuleListItemApiModel, AuditTimestampsApiModel {
    isDeleted: boolean;
    createdBy: AuditActor | null;
    updatedBy: AuditActor | null;
    deletedBy: AuditActor | null;
...
//# sourceMappingURL=pricing.api.model.d.ts.map