...
import { AdminVehicleBrandListItemApiModel } from './vehicle-brand.api.model';
...
export interface AdminVehicleDetailApiModel extends Omit<AdminVehicleListItemApiModel, 'brand' | 'createdAt'>, AuditTimestampsApiModel {
    year: number | null;
