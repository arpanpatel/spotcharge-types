...
import {
  PartnerInquiryInvestmentRange,
  PartnerInquiryLocationReadiness,
...
export interface PartnerInquiryDetailApiModel
  extends Omit<PartnerInquiryListItemApiModel, 'createdAt'>,
